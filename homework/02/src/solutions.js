module.exports = {
  ...
  /**
   * EXTRA CREDIT TASK -> Closure trick with async (we will learn async next time). Async is not important here and has nothing to do with the solution.
   *
   * **This is probably most common "big firm" interview question with closures.**
   *
